...
namespace WebApplication2.Areas.Admin.Controllers
{
    ...
    public class NhaCungCapsController : Controller
    {
        ...
        public NhaCungCapsController(DoanmonhocContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.NhaCungCaps != null ? 
                          ...
                          Problem("Entity set 'DoanmonhocContext.NhaCungCaps'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DoanmonhocContext.NhaCungCaps'  is null.");
            }
            var nhaCungCap = await _context.NhaCungCaps.FindAsync(id);
            if (nhaCungCap != null)
            {
